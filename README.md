...
<h1>Build the back end for an e-commerce site. Take a working Express.js API and configure it to use Sequelize to interact with a MySQL database.</h1>
...
Youtube URL: https://youtu.be/IRKHGpUpo2c

GitHub Repo URL: https://github.com/alisradwan/ecommerce
